...
public class JanelaPrincipal extends JFrame {
    ...
    public void reagir(CasaGUI casaClicada) {
        ...
        if(jogo.QuantidadeDePecasBrancas() == 0){ // verifica se a quantidade de peças é 0, se for mostra na tela quem ganhou.
            JOptionPane.showMessageDialog(this, jogo.verificaVitoria());
        }

        if(jogo.QuantidadeDePecasVermelhas() == 0){ // verifica se a quantidade de peças é 0, se for mostra na tela quem ganhou.
            JOptionPane.showMessageDialog(this, jogo.verificaVitoria());
        }
    }
